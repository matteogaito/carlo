...
test("Discovery skill defines the state and task handoff contracts", async () => {
  ...
  for (const required of ["discovery_state", "findings", "decisions", "unresolved_questions", "megaprompt", "brief_markdown", "plan_markdown", "implementation_tasks", "implementation_phases"]) {
